...
//               },
//               {
//                 title: "Live News Articles",
//                 description:
//                   "Read latest news articles about various earthquakes",
//                 icon: "📰",
//               },
//               {
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="relative bg-gray-800 text-white py-20">
        ...
        <div className="container mx-auto text-center px-4 relative z-10">
          ...
          <div className="w-full max-w-4xl mx-auto h-96 rounded-lg mb-8 bg-gray-700 overflow-hidden">
            <img
              src="/api/globe/800/600"
              alt="Interactive globe visualization"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {earthquakeData.earthquakes.map((quake) => (
              <div
                ...
                className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300"
              >
                <div className="bg-gray-100 w-full h-48 rounded-lg mb-4 overflow-hidden">
                  <img
                    src="/api/eq2/400/200"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4">{feature.title}</h3>
                <p className="text-gray-300">{feature.description}</p>
                <div className="mt-6 bg-gray-600 w-full h-48 rounded-lg overflow-hidden">
                  <img
                    src="/api/eq1/400/200"
      ...
      <div className="container mx-auto py-16 px-4 text-center">
        <h2 className="text-4xl font-bold mb-8">Stay Informed and Prepared</h2>
        <div className="bg-gray-200 w-full max-w-4xl mx-auto h-96 rounded-lg mb-8 overflow-hidden">
          <img
            src="/api/safety/800/400"
            alt="Emergency preparedness guide"
            className="w-full h-full object-cover"
          />
        </div>
        <p className="text-xl mb-8 max-w-2xl mx-auto">
